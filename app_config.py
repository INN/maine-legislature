...
PROJECT_SLUG = 'maine-legislature'

# Project name to be used in file paths
PROJECT_FILENAME = 'maine_legislature'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '14iR8kCI0H-e_CA96DJBTbUOfNE3x4jql8duGsAOHkjU'
COPY_PATH = 'data/Maine Legislature 2017.xlsx'
